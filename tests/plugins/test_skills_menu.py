"""Tests for fid_coder/plugins/agent_skills/skills_menu.py"""

from pathlib import Path
from unittest.mock import MagicMock, patch

from fid_coder.plugins.agent_skills.discovery import SkillInfo
from fid_coder.plugins.agent_skills.metadata import SkillMetadata
...
_MOD = "fid_coder.plugins.agent_skills.skills_menu"
...
class TestSkillsMenuInit:
    ...
    def test_init_empty(self, mock_disc, mock_dis, mock_dirs, mock_en):
        from fid_coder.plugins.agent_skills.skills_menu import SkillsMenu
...
class TestPromptForDirectory:
    def test_prompt_returns_path(self):
        with patch(
            ...
            from fid_coder.plugins.agent_skills.skills_menu import (
...
class TestShowSkillsMenu:
    ...
    def test_quit(self, mock_cls):
        ...
        from fid_coder.plugins.agent_skills.skills_menu import show_skills_menu
    ...
    def test_install_flow(self, mock_cls):
        ...
        mock_cls.return_value = mock_menu
        with patch(
            "fid_coder.plugins.agent_skills.skills_install_menu.run_skills_install_menu",
            return_value=True,
        ):
            from fid_coder.plugins.agent_skills.skills_menu import show_skills_menu
...
class TestListSkills:
    ...
    def test_no_skills(self, mock_disc):
        from fid_coder.plugins.agent_skills.skills_menu import list_skills
...
class TestHandleSkillsCommand:
    ...
    def test_no_args(self, mock_show):
        from fid_coder.plugins.agent_skills.skills_menu import handle_skills_command
...
class TestEnableDisableSkill:
    ...
    def test_enable_success(self, *mocks):
        from fid_coder.plugins.agent_skills.skills_menu import _enable_skill
    ...
    def test_disable_success(self, *mocks):
        from fid_coder.plugins.agent_skills.skills_menu import _disable_skill
...
class TestToggleAndRefresh:
    ...
    @patch(f"{_MOD}.refresh_skill_cache")
    def test_refresh(self, mock_ref):
        from fid_coder.plugins.agent_skills.skills_menu import _refresh_skills
...
class TestShowHelp:
    def test_show_help(self):
        from fid_coder.plugins.agent_skills.skills_menu import _show_help
