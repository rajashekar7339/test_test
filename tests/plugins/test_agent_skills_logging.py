...
_REGISTER_CALLBACKS_MODULE = "fid_coder.plugins.agent_skills.register_callbacks"
_AGENT_SKILLS_PACKAGE = "fid_coder.plugins.agent_skills"
...
def test_prompt_section_skips_invalid_skill_metadata_quietly(
    ...
    try:
        from fid_coder.plugins.agent_skills import register_callbacks
