...
class TestGlobalQueueFunctions:
    ...
    def test_get_global_queue_creates_queue(self):
        ...
        import fid_coder.messaging.message_queue as mq_module
...
class TestEmitPrompt:
    ...
    def test_emit_prompt(self):
        ...
        with patch(
            "fid_coder.command_line.utils.safe_input", return_value="user input"
        ) as mock_input:
            from fid_coder.messaging.message_queue import emit_prompt
