...
class TestAgentTools:
    ...
    def test_invoke_agent_imports_load_fid_rules_from_builder(self):
        """Regression: ``load_fid_rules`` is a free function in ``_builder``,
        ...
        'load_fid_rules'``) ship to prod. Pin the actual contract now.
        """
        ...
        assert not hasattr(BaseAgent, "load_fid_rules")

        # The free function is the canonical entry point.
        assert callable(_builder.load_fid_rules)
