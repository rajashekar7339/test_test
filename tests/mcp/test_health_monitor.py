...
from fid_coder.mcp_.health_monitor import (
    HealthCheckResult,
    HealthMonitor,
    HealthStatus,
)
from fid_coder.mcp_.managed_server import ManagedMCPServer
...
class TestHealthMonitor:
    ...
    async def test_start_stop_monitoring(self, health_monitor, mock_server):
        ...
        with patch("fid_coder.mcp_.health_monitor.logger") as mock_logger:
            await health_monitor.start_monitoring(server_id, mock_server)
