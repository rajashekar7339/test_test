...
from fid_coder.tools.ask_user_question.renderers import (
    _render_help_overlay,
    _render_option,
    render_question_panel,
)
from fid_coder.tools.ask_user_question.terminal_ui import QuestionUIState
from fid_coder.tools.ask_user_question.theme import RichColors
...
class TestMarkupInjectionResistance:
    ...
    def test_renderer_never_propagates_exceptions(self, monkeypatch):
        ...
        from fid_coder.tools.ask_user_question import renderers
