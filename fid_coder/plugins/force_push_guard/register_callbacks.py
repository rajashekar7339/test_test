...
from fid_coder.config import get_disable_dangerous_command_guard
from fid_coder.messaging import emit_info, emit_warning
from fid_coder.plugins.force_push_guard.detector import detect_force_push
...
def _block_command(command: str, match: Any) -> Dict[str, Any]:
    ...
    error_message = (
        ...
        f"in your terminal (outside code fid) after double-checking the target branch."
    )
