...
Historically, fid_coder used a local static catalog. We now source skills from
`remote_catalog.fetch_remote_catalog()` while keeping the same access patterns.

Public API:
    from fid_coder.plugins.agent_skills.skill_catalog import (
        SkillCatalog,
        SkillCatalogEntry,
...
from fid_coder.plugins.agent_skills.remote_catalog import fetch_remote_catalog
