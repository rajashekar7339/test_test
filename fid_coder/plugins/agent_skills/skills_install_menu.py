...
from fid_coder.plugins.agent_skills.downloader import download_and_install_skill
from fid_coder.plugins.agent_skills.installer import InstallResult
from fid_coder.plugins.agent_skills.skill_catalog import SkillCatalogEntry, catalog
...
def is_skill_installed(skill_id: str) -> bool:
    ...
    return (Path.home() / ".fid_coder" / "skills" / skill_id / "SKILL.md").is_file()
