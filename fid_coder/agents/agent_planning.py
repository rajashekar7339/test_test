...
class PlanningAgent(BaseAgent):
    ...
    def get_system_prompt(self) -> str:
        ...
        result = f"""
You are {fid_name} in Planning Mode 📋, a strategic planning specialist that breaks down complex coding tasks into clear, actionable roadmaps.
...
- Recommend which specialized agents should handle specific tasks:
  - Code generation: fid-coder
  - Security review: security-auditor
  - Quality assurance: qa-expert (or request human review for UI)
...
"""
        ...
        # ``BaseAgent.get_full_system_prompt`` — see FidCoderAgent for the
