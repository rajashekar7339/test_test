...
from fid_coder.agents._compaction import summarize
from fid_coder.agents._history import (
    estimate_context_overhead,
    estimate_tokens_for_message,
    hash_message,
)
from fid_coder.agents._runtime import run_with_mcp, should_retry_streaming
...
class BaseAgent(ABC):
    """Abstract base for all Fid Coder agents."""
    ...
    def __init__(self) -> None:
        ...
        self._fid_rules: Optional[str] = None
