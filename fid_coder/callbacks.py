...
def on_load_prompt():
    ...
    every callsite (agent_fid_coder, agent_planning, agent_tools, ...) free
...
def on_awaiting_user_input(awaiting: bool) -> List[Any]:
    """Fired whenever fid-coder starts or stops waiting on the human.
...
def on_register_cli_args(parser: Any) -> List[Any]:
    """Let plugins contribute top-level arguments to the ``fid-coder`` CLI.
