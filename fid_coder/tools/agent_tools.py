...
def register_list_agents(agent):
    ...
    def list_agents(context: RunContext) -> ListAgentsOutput:
        ...
        try:
            from fid_coder.agents import get_agent_descriptions, get_available_agents
...
# fid_coder.tools.agent_tools. The implementation lives in the focused
# subagent_invocation module so this file stays below the fid bloat line.
from fid_coder.tools.subagent_invocation import (  # noqa: E402
