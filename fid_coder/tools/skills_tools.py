...
def register_activate_skill(agent):
    ...
    async def activate_skill(
        ...
        # Import from plugin
        from fid_coder.plugins.agent_skills.config import get_skills_enabled
        from fid_coder.plugins.agent_skills.enabled_skills import iter_enabled_skills
...
def register_list_or_search_skills(agent):
    ...
    async def list_or_search_skills(
        ...
        # treated as one substring (so "code fid architecture" matched nothing).
        if query:
