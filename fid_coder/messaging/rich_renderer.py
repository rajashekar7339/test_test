...
This module implements the presentation layer for Fid Coder's messaging system.
...
class RichConsoleRenderer:
    ...
    def _do_render_uncoordinated(self, message: AnyMessage) -> None:
        ...
        **Output-level gate** (low/medium/high) runs after the pause check
        ...
        # -- Individual suppress toggles (dead-code wiring: fid_coder_oss-dzz) --
    ...
    def _render_skill_list(self, msg: SkillListMessage) -> None:
        ...
        if not msg.skills:
            ...
            self._console.print("[dim]  Install skills in ~/.fid_coder/skills/[/dim]\n")
            return
