...
def _warn_unbound_servers(server_names: List[str], agent_name: str) -> None:
    ...
    Companion to ``fid_coder.agents._builder._warn_missing_server``: that one
    ...
    try:
        from fid_coder.config import get_mcp_unbound_warning_silenced
...
class MCPManager:
    ...
    def sync_from_config(self) -> None:
        ...
        """
        try:
            from fid_coder.config import load_mcp_server_configs
    ...
    def remove_server(self, server_id: str) -> bool:
        ...
        if registry_removed or managed_removed:
            ...
            try:
                from fid_coder.mcp_.agent_bindings import (
